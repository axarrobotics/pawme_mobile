...
import 'wifi_guide_page.dart'; // Added this import
...
class _HomePageState extends State<HomePage> {
  ...
  static const Color _backgroundColor = Color(0xFF0B121E);
  static const Color _cardColor = Color(0xFF161D2B);
  static const Color _accentBlue = Color(0xFF007BFF);
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          const Text('Welcome back to PawMe', style: TextStyle(color: _textSecondary, fontSize: 12)),
                        ],
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          if (mounted) Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const SignInPage()));
                        },
              ...
              const Text('Your Robots', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  const Text('Daily Routines', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
                  TextButton(onPressed: () {}, child: const Text('Manage All', style: TextStyle(color: _accentBlue))),
                ],
              ),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              const Icon(Icons.show_chart, color: _accentBlue, size: 20),
            ],
          ),
          ...
          Row(
            children: [
              ...
              Text(status, style: const TextStyle(color: _textSecondary, fontSize: 10, fontWeight: FontWeight.bold)),
            ],
          ),
          const Spacer(),
          Row(
  ...
  Widget _buildMetric(String label, String value, IconData icon) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(children: [Icon(icon, size: 12, color: _textSecondary), const SizedBox(width: 4), Text(label, style: const TextStyle(color: _textSecondary, fontSize: 10))]),
        const SizedBox(height: 4),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: const Column(
          ...
          children: [
            Icon(Icons.add, color: _textSecondary, size: 32),
            SizedBox(height: 8),
            Text('Connect New Robot', style: TextStyle(color: _textSecondary, fontSize: 14)),
          ],
        ),
      ),
    );
